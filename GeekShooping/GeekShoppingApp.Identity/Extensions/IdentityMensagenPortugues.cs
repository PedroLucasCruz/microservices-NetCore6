...
{
    public class IdentityMensagenPortugues : IdentityErrorDescriber //Herda a classe de descrição de erros
    {
        ...
        public override IdentityError InvalidUserName(string userName) { return new IdentityError { Code = nameof(InvalidUserName), Description = $"O login '{userName}' é invalido, pode conter apenas letras ou dígitos." }; }
        ...
        //01:01 - customizando as mensagens do idetity
    }
}
